...
const ZakatCalculator = () => {
    ...
    const calculateZakat = async () => {
      ...
      try {
        ...
        // Get detailed analysis using the new function
        const detailedAnalysis = await getDetailedZakatAnalysis(assets, totalAssets, nisab.nisabThreshold, currency);
    ...
    // Render results section including the detailed analysis
    const renderResults = () => (
      <div className="mt-6 space-y-6">
        ...
        {/* Detailed Analysis */}
        {results.detailedAnalysis && <ZakatAnalysisDisplay analysis={results.detailedAnalysis} currency={currency} />}
      </div>
    );
          ...
          <div className="relative max-w-4xl mx-auto px-4 py-8 md:py-16">
            ...
            <Card>
              ...
              <CardContent>
                ...
                {/* Results Section */}
                {results.totalAssets > 0 && renderResults()}
              </CardContent>
            </Card>
